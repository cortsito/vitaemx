  ...
  return (
    <div>
      <div className="card article">
        <p className="section-title">Metodología</p>
        <p>
          Cada número de esta aplicación se puede rastrear hasta una fórmula y un supuesto
          declarado. El documento completo está en el repositorio:{' '}
        ...
        <p>
          <strong>1. Tablas de vida.</strong> qx se obtiene de las defunciones y la población a
          mitad de año proyectadas por CONAPO, por edad simple, sexo y entidad: mx = D/P, qx = mx /
          (1 + (1 − ax)·mx), con ax = 0.5 (0.1 a edad 0). lx, dx, Lx, Tx y ex siguen la recursión
          estándar con l₀ = 100,000. La última edad con exposición se cierra como intervalo abierto.
        </p>
        <p>
        ...
        <p>
          <strong>3. Primas.</strong> Prima neta única temporal A¹ₓ:ₙ = Σ v^(k+1) · ₖ|qₓ (k =
          0…n−1), vida entera hasta el final de la tabla, y prima anual nivelada = prima única / äₓ
          (o äₓ:ₙ), todo con v = 1/(1+i) y la serie lx reconstruida a partir de la qx ajustada.
        </p>
        <p>
      ...
      <div className="methodology-grid">
        <div className="card">
          <p className="section-title">Versión de datos servida</p>
        ...
        <div className="card">
          <p className="section-title">Validación: esperanza de vida al nacer</p>
          <p className="muted">
